...
List<Message> _templates = [
  Message(
    profilePic: AssetImage('assets/images/profile_pic1.jpg'),
  ...
  Message(
    profilePic: AssetImage('assets/images/profile_pic2.jpg'),
    userName: 'Sleepy Dev',
    messageText:
  ...
  Message(
    profilePic: AssetImage('assets/images/profile_pic3.jpg'),
